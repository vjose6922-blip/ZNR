...
function injectAdminStyles() {
  if (document.querySelector('#admin-specific-styles')) return;
  ...
  const adminStyles = `
    <style id="admin-specific-styles">
      ...
      /* Ajustar el wrapper de productos */
      .admin-products-wrapper {
        max-width: 100%;
        overflow-x: auto;
      }
      
      /* Asegurar que las tarjetas/productos no se desborden */
      .admin-products-list {
        display: flex;
      ...
      /* Contenedor de estadísticas con ancho controlado */
      .admin-stats-grid {
        display: grid;
      ...
      /* Barra de filtros con ancho controlado */
      .admin-filters-bar {
        display: flex;
        flex-wrap: wrap;
        gap: 12px;
      ...
      /* Tabla/lista de productos responsive */
